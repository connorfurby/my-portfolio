...
export const internshipEntries: ExperienceEntry[] = [
  {
    ...
    logoText: "CL",
    logoImageSrc: "/experience-logos/concierge-law.png",
    accent: "221 48% 20%",
    accentSecondary: "217 36% 34%",
  ...
  },
  {
    ...
    logoText: "DZ",
    logoImageSrc: "/experience-logos/district-zero.png",
    accent: "0 86% 58%",
    accentSecondary: "5 90% 66%",
...
export const workEntries: ExperienceEntry[] = [
  {
    ...
    logoText: "ΣΦΕ",
    logoImageSrc: "/experience-logos/sigep.png",
    accent: "282 54% 42%",
    accentSecondary: "47 92% 58%",
    accentTertiary: "0 84% 56%",
  ...
  },
  {
    ...
    logoText: "JJ",
    logoImageSrc: "/experience-logos/jimmy-johns.png",
    accent: "0 82% 52%",
    accentSecondary: "4 90% 62%",
...
export const volunteerEntries: ExperienceEntry[] = [
  {
    ...
    logoText: "CB",
    logoImageSrc: "/experience-logos/codebytes.png",
    accent: "183 78% 44%",
    accentSecondary: "188 72% 58%",
  ...
  },
  {
    ...
    logoText: "SH",
    logoImageSrc: "/experience-logos/schoolhouse.png",
    accent: "129 42% 56%",
    accentSecondary: "118 36% 66%",
  ...
  },
  {
    ...
    logoText: "STEM",
    logoImageSrc: "/experience-logos/special-needs-stem-camp.png",
    accent: "136 58% 24%",
    accentSecondary: "145 44% 34%",
